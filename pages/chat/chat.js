  ...
  return (
    <div className={`${styles.chat_page}`}>
      <div className={`${styles.chat_page_container}`}>
        <chatContext.Provider value={{ isChatActive, setisChatActive, handleChatActive, authToken }}>
          <ChatList
                ...
                <div className={`${styles.chats}`}>
                  <ul>
                    {messages ? messages.map((message, idx) => (
                      <li key={idx}>
                        <div className={message.id_sender === userData.email ? `${styles.yours}` : `${styles.others}`} align="right">
                          <p>{message.message}</p>
                  ...
                  <div className={`${styles.typer}`}>
                    <form onSubmit={handleSendMessage} autoComplete="off">
                      <input type="text" name='message' placeholder='type your message here...'
                        onChange={handleMessage} autoFocus
                      />
