...
const SignUp = () => {
    ...
    useEffect(() => {
        ...
        if (Object.keys(formErrors).length === 0 && isSubmit) {
            ...
            const sendRegis = async () => {
                try {
                    setButtonDisable(true)
                    await axios.post(`${process.env.NEXT_PUBLIC_API_URL}/v1/users/registration`, signUpData)
                ...
                >
                    <div className={`${styles.signup_container}`}>
                        ...
                        <form onSubmit={handleSignUp} className={`${styles.forms}`}>
                            ...
                            <Button
                                text={buttonDisable ? 'Loading...' : 'Register'}
                                type={'submit'}
                                style={buttonDisable ? { pointerEvents: 'none' } : {}}
                            />
                        </form>
                        <div className={`${styles.signup_with}`}>
                            <span></span>
                            <p>Sing Up with</p>
                            <span></span>
                        </div>
